...
public class UserControllerIntegrationTest {
    ...
    private static UserRegistrationDto testUserDto;
    ...
    public static void setUp() {
        // Create a test user
        testUserDto = new UserRegistrationDto("testing", "testuser@example.com", "123456");
    }
    @Test
    @WithMockUser (username = "adminUser", password = "password", roles = "ADMIN")
 ...
 */
    ...
    public void testGetUserByUserName() throws Exception {
        mockMvc.perform(get("/user/getByUserName/{userName}", "daniTesting31"))  // Replace "username" with an actual username
                .andExpect(status().isOk())
                .andExpect(content().contentType(MediaType.APPLICATION_JSON));
    }
    ...
    public void testUpdateUser() throws Exception {
        ...
        String requestBody = "{\"username\":\"daniTesting31\",\"email\":\"newEmail@example.com\"}";

        mockMvc.perform(put("/user/update/{username}", "damiTesting33")  // Replace "existingUsername" with an actual username
